                ...
                <div class="card-body">
                    ...
                    <form id="formEditarCamera" novalidate>
                        ...
                        <div class="card alarme-section-card mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check mt-2">
                                    ...
                                    <label class="form-check-label" for="toggleModeloExistente">Usar modelo existente</label>
                                </div>
                            </div>
                            </div></div></div>
                        ...
                        <div class="card alarme-section-card mb-3">
                            ...
                            <!-- Seção LPR -->
                            <div class="card alarme-section-card mb-3" id="secaoEditLPR" style="display:none">
                            <div class="card-header alarme-section-header d-flex align-items-center gap-2">
                                <i class="fas fa-car"></i>
                                <span>Especificações LPR</span>
                            </div>
                            <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4">
                            ...
                            <!-- Seção DVR -->
                            <div class="card alarme-section-card mb-3" id="secaoEditDVR" style="display:none">
                            <div class="card-header alarme-section-header d-flex align-items-center gap-2">
                                <i class="fas fa-hdd"></i>
                                <span>Especificações DVR</span>
                            </div>
                            <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4">
                            ...
                            <!-- Seção Totem -->
                            <div class="card alarme-section-card mb-3" id="secaoEditTotem" style="display:none">
                            <div class="card-header alarme-section-header d-flex align-items-center gap-2">
