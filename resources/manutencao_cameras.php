...
<div class="container-fluid mt-4 mb-4 manutencao-page">
    <div class="row mb-3">
        <div class="col-12 d-flex justify-content-between align-items-center flex-wrap gap-2">
            <div>
                <h2 class="mb-1"><i class="fas fa-tools me-2"></i>Manutenção de Câmeras</h2>
                <p class="text-muted mb-0">Registre manutenções e acompanhe o histórico completo por equipamento.</p>
            </div>
    ...
    <div class="card shadow-sm mb-3">
        ...
        <div class="card-body">
            <form id="formCriarOs" class="row g-3" novalidate>
                <div class="col-md-4">
                    <label for="equipamento_id_os" class="form-label">Câmera</label>
                    <div class="input-group mb-4">
                        <input type="text" id="filtroCamera" class="form-control" placeholder="Digite IP ou local da câmera...">
                        <button type="button" class="btn btn-outline-primary" id="btnBuscarCameraLista">
                ...
                <div class="col-md-3">
                    <label for="local_servico_os" class="form-label">Local da câmera</label>
                    <input type="text" id="local_servico_os" name="local_servico_os" class="form-control" maxlength="255" readonly>
                </div>
                <div class="col-md-5">
                    <label for="endereco_servico_os" class="form-label">Endereço da câmera</label>
    ...
    <div class="card shadow-sm mb-3">
        ...
        <div class="card-body">
            ...
            <form id="formManutencaoCamera" class="row g-3" novalidate>
                <input type="hidden" id="os_id" name="os_id" value="">
                <div class="col-md-6">
                    <label for="equipamento_id" class="form-label">Câmera</label>
                ...
                <div class="col-md-4">
                    ...
                    <textarea id="pecas_previstas" name="pecas_previstas" class="form-control" rows="3" maxlength="2000" placeholder="Cabos, conectores, fonte, camera..."></textarea>
                </div>
                <div class="col-12 d-flex gap-2 flex-wrap">
            ...
            <div id="secaoAnexosManutencao" class="anexos-section-pending d-none mt-4">
                ...
                <div class="anexos-editable">
                    ...
                    <div class="anexos-list mt-2" data-manutencao-camera-id="" data-empty-msg="Nenhum anexo cadastrado para esta manutenção.">
        ...
        <div class="card-header bg-light d-flex justify-content-between align-items-center flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-outline-primary btn-sm" id="btnFiltrarHistorico">
                    <i class="fas fa-filter me-1"></i>Filtrar pela camera selecionada
                </button>
                <button type="button" class="btn btn-outline-secondary btn-sm" id="btnLimparFiltroHistorico">
                    <i class="fas fa-list me-1"></i>Exibir todas
                </button>
            </div>
        </div>
        <div class="card-body">
            <div class="row g-2 mb-3">
                <div class="col-md-5">
                    ...
                    <input type="text" id="filtroBuscaHistorico" class="form-control"
                        placeholder="Buscar por descrição, câmera, IP...">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-1">
                    <label for="historicoPerPage" class="form-label">Registros/pág</label>
                    <select id="historicoPerPage" class="form-select">
                        ...
                        <tr>
                            ...
                            <th style="min-width: 100px; background-color: #f8f9fa;">
                                <button type="button" class="sort-header-btn" data-sort="numero_os">
                                    Nº OS <span data-sort-indicator="numero_os">↕️</span>
                                </button>
                            </th>
                            <th style="min-width: 150px; background-color: #f8f9fa;">
                                <button type="button" class="sort-header-btn" data-sort="data_hora">
                                    Data <span data-sort-indicator="data_hora">↕️</span>
                                </button>
                            </th>
                            <th style="min-width: 140px; background-color: #f8f9fa;">
                                Hora
                            </th>
                            <th style="min-width: 180px; background-color: #f8f9fa;">
                                <button type="button" class="sort-header-btn" data-sort="camera">
                                    Tipo <span data-sort-indicator="camera">↕️</span>
                                </button>
                            </th>
...
<div class="modal fade" id="modalManutencaoAtiva" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-warning text-dark">
        <h5 class="modal-title"><i class="fas fa-exclamation-triangle me-2"></i>Câmera em Manutenção</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fechar"></button>
      </div>
      <div class="modal-body">
        <p>A câmera <strong id="modalManutencaoNome"></strong> já possui uma ordem de serviço em aberto.</p>
        <p class="mb-0 text-muted">Selecione outra câmera ou finalize a manutenção existente.</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" id="modalManutencaoOk">OK</button>
      </div>
    </div>
  </div>
</div>
